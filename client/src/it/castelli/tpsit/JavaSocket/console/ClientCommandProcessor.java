            ...
            case "log", "login" -> {
                try {
                    if (tokens.length != 2) {
                        ...
                        Message message = new Message(Message.LOGIN_TYPE, UserLogManager.getUsername(), 0, jsonSubMessage);
            ...
            case "calc", "calculate" -> {
                ...
                if (tokens.length == 4) {
                    ...
                    try {
                        ...
                        Message message = new Message(Message.CALCULATE_TYPE, UserLogManager.getUsername(), 1, jsonSubMessage);
                        ClientMain.getConnection().send(JsonSerializer.serialize(message));
